...
class SwitchSection:
    ...
    def __init__(self, data, is_compressed, check_hash):
        ...
        self.fileOffset = struct.unpack("<I", data[0:4])[0]
        self.memoryOffset = struct.unpack("<I", data[4:8])[0]
        self.decompressedsize = struct.unpack("<I", data[8:12])[0]
        self.exSize = struct.unpack("<I", data[12:16])[0]
